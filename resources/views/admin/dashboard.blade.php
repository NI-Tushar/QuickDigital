                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-3 col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="stats-amount mr-3">
                                                <h3 class="heading-text text-bold-600">{{ $customerOrders }}</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-xl-3 col-sm-6 col-12">
                                        <a href="{{ route('admin.affiliate.order') }}"
                                            ...
                                            <div class="stats-amount mr-3">
                                                <h3 class="heading-text text-bold-600">{{ $affiliatorOrderAmount }}</h3>
                                                <p class="sub-heading">Affiliators Received Amount</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-6 col-xl-3 col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="stats-amount mr-3">
                                                <h3 class="heading-text text-bold-600">{{ $customerOrderAmount }}</h3>
                                                <p class="sub-heading">Customers Received Amount</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-3 col-sm-6 col-12">
                                        <div class="d-flex align-items-start border-right-blue-grey border-right-lighten-5">
                                            ...
                                            <div class="stats-amount mr-3">
                                                <h3 class="heading-text text-bold-600">{{ $CommissionPaid }}</h3>
                                                <p class="sub-heading">Commission Paid</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-3 col-sm-6 col-12">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="stats-amount mr-3">
                                                <h3 class="heading-text text-bold-600">{{ $CommissionPending }}</h3>
                                                <p class="sub-heading">Commission Painding</p>
                                            </div>
                                            {{-- <span class="inc-dec-percentage">
                                                <small class="danger"><i class="fa fa-long-arrow-down"></i> 13.6%</small>
                                            </span> --}}
