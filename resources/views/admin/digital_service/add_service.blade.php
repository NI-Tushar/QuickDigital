                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Digital Service</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form name="product" id="productForm" action="{{ route('add.digialservice') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="border-radius:5px;" type="text" id="name" class="form-control round" placeholder="Enter Service Title" name="title" value="{{ old('title') }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="name">Service Description</label>
                                                <textarea style="border-radius:5px;" id="desc" class="form-control round" placeholder="Enter Service Description" name="description" required>{{ old('description') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="features-container">
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="features[]" class="form-control" placeholder="Enter Service Feature" value="{{ old('features[]') }}">
                                            ...
                                            <div class="price_section">
                                                <div class="form-group">
                                                    ...
                                                    <input style="border-radius:5px;" type="number" id="actual_price" class="form-control round" placeholder="Enter Service Price" name="price" value="{{ old('price') }}">
                                                </div>
