                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form name="product" id="productForm" action="{{ url('admin/updating-service/') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Update Service Title</label>
                                                <input style="border-radius:5px;" type="text" id="name" class="form-control round" placeholder="Enter Service Title" name="title" value="{{ $services['title'] }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="name">Service Description</label>
                                                <textarea style="border-radius:5px;" id="desc" class="form-control round" placeholder="Enter Service Description" name="description" required>{{ $services['description'] }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="features-container">
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="features[]" class="form-control" placeholder="Enter Service Feature" value="{{$feature}}">
                                            ...
                                            <div class="price_section">
                                                <div class="form-group">
                                                    <label for="actual_price">Service Price</label>
                                                    <input style="border-radius:5px;" type="number" id="actual_price" class="form-control round" placeholder="Enter Service Price" name="price"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    value="{{ $services['affiliator_commission'] }}">
                                                </div>
                                            </div>
