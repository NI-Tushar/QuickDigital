                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <form action="{{ route('admin.affiliate.order.paymentStatus', $order->id) }}" onchange="submit()" method="POST">
                                            @csrf
                                            @method('PUT')
                                    ...
                                    <div class="col-4">
                                        <form action="{{ route('admin.affiliate.order.orderStatus', $order->id) }}" onchange="submit()" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                    ...
                                    <div class="col-1">
                                        <div class="form-group">
                                            ...
                                            <a style="display: block" class="btn btn-primary" href="{{ route('admin.affiliate.order') }}"><i style="font-size: 18px" class="fa-solid fa-reply-all"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-end">
                                    <a target="_blank" href="{{ route('admin.affiliate.order.DownloadOrderPDF', $order->id) }}"
